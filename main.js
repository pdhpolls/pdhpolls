...
function showInf() {
	$("#infobox").attr("data-showbox", "true");
}
function hideInf() {
	$("#infobox").attr("data-showbox", "false");
}
if(isMobile()) {
	...
	$("#info").on("touchend", showInf);
	$("#exit").on("touchend", hideInf);
} else {
	...
	$("#info").on("click", showInf);
	$("#exit").on("click", hideInf);
}
